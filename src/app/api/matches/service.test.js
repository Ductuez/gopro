...
describe("fetchAndAggregateMatches", () => {
  it("fetches multiple pages, dedupes and groups", async () => {
    const page1 = [
      {
        id: 1,
        league: { id: 10, name: "L1" },
        begin_at: "2025-09-25T01:00:00Z",
      },
      {
        id: 2,
        league: { id: 10, name: "L1" },
        begin_at: "2025-09-25T02:00:00Z",
      },
    ];
    const page2 = [
      {
      ...
      {
        id: 3,
        league: { id: 20, name: "L2" },
        begin_at: "2025-09-25T03:00:00Z",
      },
    ];
    ...
    const grouped = await fetchAndAggregateMatches({
      begin: "2025-09-25T00:00:00+07:00",
      end: "2025-09-25T23:59:59+07:00",
      perPage: 2,
      maxPages: 5,
      token: "test",
    });
