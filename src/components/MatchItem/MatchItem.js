...
export default function MatchItem({ begin_at, opponents, games, winner_id, status }) {
  ...
  return (
    <li className="flex items-center justify-between px-3 py-2 rounded-md cursor-pointer border transition-colors bg-black-700 border-white-10 hover:bg-purple-hover" style={{ opacity: 0.8 }}>
            ...
            <div className="w-4 h-4 rounded overflow-hidden bg-gray-700 flex-shrink-0">
              {team1?.image_url ? (
                ...
                <div className="w-full h-full bg-gray-600 flex items-center justify-center">
                  <span className="text-xs text-white">{team1Name.slice(0, 1)}</span>
                </div>
              )}
            </div>
          ...
          <div className="flex items-center space-x-2">
            <div className="w-4 h-4 rounded overflow-hidden bg-gray-700 flex-shrink-0">
              {team2?.image_url ? (
                ...
                <div className="w-full h-full bg-gray-600 flex items-center justify-center">
                  <span className="text-xs text-white">{team2Name.slice(0, 1)}</span>
                </div>
              )}
            </div>
            <span className={`text-sm ${
