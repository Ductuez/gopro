        ...
        <div className="flex items-center rounded-lg border bg-gray-800 border-gray-600 relative">
          ...
          <div className="relative" ref={calendarRef}>
            <button
              onClick={() => {
                console.log(
                  "Calendar button clicked, current showCalendar:",
                  showCalendar,
                );
            ...
            {showCalendar && (
              <div
                className="absolute top-full left-1/2 transform -translate-x-1/2 z-[9999] mt-2 bg-gray-900 border border-gray-700 rounded-lg p-4 shadow-xl w-80"
                style={{ zIndex: 9999 }}
              >
                {/* Calendar Header */}
                ...
                <div className="grid grid-cols-7 gap-1 mb-2">
                  {["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"].map(
                    (day) => (
                      <div
                        key={day}
                        className="text-center text-gray-400 text-xs py-1 font-medium"
                      >
                        {day}
                      </div>
                    ),
